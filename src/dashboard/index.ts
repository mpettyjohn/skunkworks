...
export { initRegistry, registerProject, unregisterProject, listProjects, pruneStale, getProject, getProjectByPath, touchProject, getRegistryPath } from './registry.js';
